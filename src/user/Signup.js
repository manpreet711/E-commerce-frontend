...
const Signup = () => {
                ...
                <div className="col-md-6 offset-sm-3 text-left">
                    <form>
                        <div className="form-group">
                            <label className="text-lignt">Name</label>
        ...
        <div className="row">
            <div className="col-md-6 offset-sm-3 text-left">
                <div className="alert alert-success" style={{display: success? "" : "none"}}>
                    New account was created Successfully. Please<Link to ="/signin">Login Hear</Link>
                </div>
            </div>
        </div>
        );   
    ...
    return(
        <Base title= "Signup Page" description="A page for user to signup !">
            ...
            {errorMessage()}
            {signUpForm()}
            <p className="text-white text-center pt-2">Already have an account<Link className="text-warning" to="/signin"> click here </Link> to signin.</p>
